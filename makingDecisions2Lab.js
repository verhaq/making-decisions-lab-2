...
// Use an if statement to check the length of the 'myFavoriteNumbers' array. If it's less than 7, log
// 'There are not enough elements in this array' to the console. 
// If the length is more than 7, reassign the value of 'someNum' to the value of the 7th element 
//in the array. (Hint: how can you make sure that your code works for exactly 7 elements?
...
/* The famous FizzBuzz, Devmountain style!
  Create a for loop that iterates from 1 to 100. In this for loop, using some conditional logic, if the
  number your for loop is currently on is divisible by 3, console.log 'Dev'. 
